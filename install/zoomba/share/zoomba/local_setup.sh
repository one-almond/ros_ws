...
: ${AMENT_CURRENT_PREFIX:="/ros_ws/install/zoomba"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zoomba/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zoomba/environment/path.sh"
